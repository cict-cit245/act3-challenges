...
text_output_file = f"file_metadata_{timestamp}.txt"
...
""")
        ...
        <a href="{text_output_file}" download style="text-decoration: none; margin-left: 10px;">
...
""")
    ...
    print(f"Metadata has been written to {output_file} and {text_output_file}")
except Exception as e:
